          ...
          <aside className="lg:col-span-4 animate-in slide-in-from-right-8 duration-500 sticky top-8 h-fit">
            <div className="bg-slate-900 rounded-[32px] overflow-hidden shadow-2xl text-white">
              ...
              <div className="px-8 pb-10 -mt-12 space-y-8">
                <div className="space-y-4">
                  <div className="relative inline-block">
                    <img 
                      ...
                      className="w-24 h-24 rounded-3xl border-4 border-slate-900 bg-slate-800 shadow-xl"
                    />
                ...
                <button className="w-full flex items-center justify-center gap-2 h-12 bg-white text-slate-900 rounded-2xl font-bold text-sm hover:bg-slate-100 transition-all active:scale-95">
                ...
                {filteredUsers.map(u => (
                  ...
                  >
                    <div className="relative">
                      <img src={u.avatar} alt={u.name} className="w-12 h-12 rounded-xl bg-slate-100 border border-slate-100 group-hover:border-slate-300 transition-all" />
                      {u.role === 'admin' && (
